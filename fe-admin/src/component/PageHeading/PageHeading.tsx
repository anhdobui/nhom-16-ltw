...
function PageHeading({ title }: PageHeadingType) {
	...
	return (
		<>
			{title && (
				<div className=" my-6 mx-auto flex flex-col items-start justify-between border-b border-gray-300 px-6 pb-4 md:flex-row md:items-center lg:my-12">
					<div>
						...
						<ul
							...
							className="mt-3 flex flex-col items-start text-sm text-gray-600 dark:text-gray-400 md:flex-row md:items-center"
						>
